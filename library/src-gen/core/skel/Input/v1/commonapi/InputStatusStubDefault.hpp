...
*/
#ifndef V1_COMMONAPI_Input_Status_STUB_DEFAULT_HPP_
#define V1_COMMONAPI_Input_Status_STUB_DEFAULT_HPP_
...
/**
 * Provides a default implementation for InputStatusStubRemoteEvent and
 * InputStatusStub. Method callbacks have an empty implementation,
 ...
 * behaviour.
 */
class COMMONAPI_EXPORT_CLASS_EXPLICIT InputStatusStubDefault
    : public virtual InputStatusStub {
public:
    COMMONAPI_EXPORT InputStatusStubDefault()
        : remoteEventHandler_(this),
          interfaceVersion_(InputStatus::getInterfaceVersion()) {
    }
    ...
    COMMONAPI_EXPORT InputStatusStubRemoteEvent* initStubAdapter(const std::shared_ptr< InputStatusStubAdapter> &_adapter) {
        CommonAPI::Stub<InputStatusStubAdapter, InputStatusStubRemoteEvent>::stubAdapter_ = _adapter;
    ...
    COMMONAPI_EXPORT virtual void setSteeringAttribute(const std::shared_ptr<CommonAPI::ClientId> _client, float _value) {
        (void)_client;
        setSteeringAttribute(_value);
    }
    ...
    COMMONAPI_EXPORT virtual void setThrottleAttribute(const std::shared_ptr<CommonAPI::ClientId> _client, float _value) {
        (void)_client;
        setThrottleAttribute(_value);
    }
    COMMONAPI_EXPORT virtual void fireGearSelectEvent(const uint8_t &_setGear) {
        InputStatusStub::fireGearSelectEvent(_setGear);
    }
...
protected:
    COMMONAPI_EXPORT virtual bool trySetBrakeAttribute(bool _value) {
        ...
        bool valueChanged;
        std::shared_ptr<InputStatusStubAdapter> stubAdapter = CommonAPI::Stub<InputStatusStubAdapter, InputStatusStubRemoteEvent>::stubAdapter_.lock();
        if(stubAdapter) {
    ...
    COMMONAPI_EXPORT virtual void onRemoteSteeringAttributeChanged() {
        // No operation in default
    }
    ...
    COMMONAPI_EXPORT virtual void onRemoteThrottleAttributeChanged() {
        // No operation in default
    }
    class COMMONAPI_EXPORT_CLASS_EXPLICIT RemoteEventHandler: public virtual InputStatusStubRemoteEvent {
    public:
        COMMONAPI_EXPORT RemoteEventHandler(InputStatusStubDefault *_defaultStub)
            : 
        ...
        COMMONAPI_EXPORT virtual void onRemoteSteeringAttributeChanged() {
            assert(defaultStub_ !=NULL);
            defaultStub_->onRemoteSteeringAttributeChanged();
        }

        COMMONAPI_EXPORT virtual bool onRemoteSetSteeringAttribute(float _value) {
            assert(defaultStub_ !=NULL);
            return defaultStub_->trySetSteeringAttribute(std::move(_value));
        }

        COMMONAPI_EXPORT virtual bool onRemoteSetSteeringAttribute(const std::shared_ptr<CommonAPI::ClientId> _client, float _value) {
            (void)_client;
            return onRemoteSetSteeringAttribute(_value);
        }
        COMMONAPI_EXPORT virtual void onRemoteThrottleAttributeChanged() {
            assert(defaultStub_ !=NULL);
            defaultStub_->onRemoteThrottleAttributeChanged();
        }

        COMMONAPI_EXPORT virtual bool onRemoteSetThrottleAttribute(float _value) {
            assert(defaultStub_ !=NULL);
            return defaultStub_->trySetThrottleAttribute(std::move(_value));
        }

        COMMONAPI_EXPORT virtual bool onRemoteSetThrottleAttribute(const std::shared_ptr<CommonAPI::ClientId> _client, float _value) {
            (void)_client;
            return onRemoteSetThrottleAttribute(_value);
        }

    private:
        InputStatusStubDefault *defaultStub_;
    };
protected:
    InputStatusStubDefault::RemoteEventHandler remoteEventHandler_;
...
#endif // V1_COMMONAPI_Input_Status_STUB_DEFAULT
