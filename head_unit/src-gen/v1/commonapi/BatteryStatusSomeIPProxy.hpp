 ...
 */
#ifndef V1_COMMONAPI_BATTERY_STATUS_SOMEIP_PROXY_HPP_
#define V1_COMMONAPI_BATTERY_STATUS_SOMEIP_PROXY_HPP_
...
class BatteryStatusSomeIPProxy
    : virtual public BatteryStatusProxyBase,
      virtual public CommonAPI::SomeIP::Proxy {
public:
    BatteryStatusSomeIPProxy(
        const CommonAPI::SomeIP::Address &_address,
        const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection);

    virtual ~BatteryStatusSomeIPProxy();
...
#endif // V1_COMMONAPI_Battery_Status_SOMEIP_PROXY_HPP_
