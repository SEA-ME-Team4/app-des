 ...
 */
#ifndef V1_COMMONAPI_SPEED_STATUS_SOMEIP_PROXY_HPP_
#define V1_COMMONAPI_SPEED_STATUS_SOMEIP_PROXY_HPP_
...
class SpeedStatusSomeIPProxy
    : virtual public SpeedStatusProxyBase,
      virtual public CommonAPI::SomeIP::Proxy {
public:
    SpeedStatusSomeIPProxy(
        const CommonAPI::SomeIP::Address &_address,
        const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection);

    virtual ~SpeedStatusSomeIPProxy();
...
#endif // V1_COMMONAPI_Speed_Status_SOMEIP_PROXY_HPP_
